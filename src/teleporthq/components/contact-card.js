...
const ContactCard = (props) => {
  return (
    <div className={`contact-card-gallery-card ${props.rootClassName} `}>
      <img
        alt={props.image_alt}
        src={props.image_src}
        className="contact-card-photo"
      />
      <h2 className="contact-card-name">{props.Name}</h2>
      <span className="contact-card-job-title">{props.JobTitle}</span>
      <div className="contact-card-container">
        <svg viewBox="0 0 1024 1024" className="contact-card-phone">
          <path
        ...
        <Link to="/messaging-gs" className="contact-card-navlink">
          <svg viewBox="0 0 1024 1024" className="contact-card-chat">
            <path
        ...
        >
          <svg viewBox="0 0 1024 1024" className="contact-card-email">
            <path
      ...
      <div className="contact-card-container1">
        <span className="contact-card-text Heading">{props.text}</span>
      </div>
    </div>
  )
}
...
ContactCard.defaultProps = {
  image_alt: 'image',
  image_src: '/playground_assets/woman.jpg',
  rootClassName: '',
  text: '<   SWIPE   >',
  Name: 'Name',
